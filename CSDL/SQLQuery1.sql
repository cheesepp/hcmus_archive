USE [master]
GO
/****** Object:  Database [QLKhoaLuan]    Script Date: 19/5/2023 3:09:56 PM ******/
CREATE DATABASE [QLKhoaLuan]
GO
USE [QLKhoaLuan]
GO
/****** Object:  Table [dbo].[DeTai_TN]    Script Date: 19/5/2023 3:09:56 PM ******/
CREATE TABLE [dbo].[DeTai_TN](
 ...
 CONSTRAINT [PK_DeTai_TN] PRIMARY KEY 
(
	[MaDT] ASC
))
GO
/****** Object:  Table [dbo].[GiaoVien]    Script Date: 19/5/2023 3:09:56 PM ******/
...
GO
/****** Object:  Table [dbo].[HoiDong]    Script Date: 19/5/2023 3:09:56 PM ******/
...
CREATE TABLE [dbo].[HoiDong](
 ...
 CONSTRAINT [PK_HoiDong] PRIMARY KEY  
(
	[Nam] ASC,
	[Dot_BV] ASC,
	[MaNganh] ASC
...
GO
/****** Object:  Table [dbo].[LichBaoVe]    Script Date: 19/5/2023 3:09:56 PM ******/
CREATE TABLE [dbo].[LichBaoVe](
	...
	[Diem_HD] [int] NULL,
	[TongDiem] [int] NULL,
 CONSTRAINT [PK_LichBaoVe_1] PRIMARY KEY  
(
	[Nam] ASC,
	[Dot_BV] ASC,
	[MaNganh] ASC,
...
GO
/****** Object:  Table [dbo].[Loai_DeTai]    Script Date: 19/5/2023 3:09:56 PM ******/
CREATE TABLE [dbo].[Loai_DeTai](
	[MaLoai] [varchar](5) NOT NULL,
	[TenLoai] [nvarchar](50) NULL,
	[SoTC] [int] NULL,
 CONSTRAINT [PK_Loai_DeTai] PRIMARY KEY  
(
	[MaLoai] ASC
)
)
GO
/****** Object:  Table [dbo].[Nganh]    Script Date: 19/5/2023 3:09:56 PM ******/
CREATE TABLE [dbo].[Nganh](
	[MaNganh] [varchar](5) NOT NULL,
	[TenNganh] [nvarchar](50) NULL,
	[TruongNganh] [varchar](5) NULL,
	[NamTL] [int] NULL,
 CONSTRAINT [PK_Nganh] PRIMARY KEY  
(
	[MaNganh] ASC
)
) 
GO
/****** Object:  Table [dbo].[SinhVien]    Script Date: 19/5/2023 3:09:56 PM ******/
...
GO
INSERT [dbo].[LichBaoVe] ([Nam], [Dot_BV], [MaNganh], [MaSV], [MaDT], [Diem_UV], [Diem_TK], [Diem_PB], [Diem_HD], [TongDiem]) VALUES (2021, 1, N'HTTT', N'SV01', N'DT01', 9, 8, 9, 9, NULL)
GO
INSERT [dbo].[LichBaoVe] ([Nam], [Dot_BV], [MaNganh], [MaSV], [MaDT], [Diem_UV], [Diem_TK], [Diem_PB], [Diem_HD], [TongDiem]) VALUES (2021, 1, N'HTTT', N'SV02', N'DT01', 9, 9, 9, 10, NULL)
GO
INSERT [dbo].[LichBaoVe] ([Nam], [Dot_BV], [MaNganh], [MaSV], [MaDT], [Diem_UV], [Diem_TK], [Diem_PB], [Diem_HD], [TongDiem]) VALUES (2021, 1, N'KTPM', N'SV03', N'DT03', NULL, NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[LichBaoVe] ([Nam], [Dot_BV], [MaNganh], [MaSV], [MaDT], [Diem_UV], [Diem_TK], [Diem_PB], [Diem_HD], [TongDiem]) VALUES (2021, 1, N'KTPM', N'SV04', N'DT03', NULL, NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[LichBaoVe] ([Nam], [Dot_BV], [MaNganh], [MaSV], [MaDT], [Diem_UV], [Diem_TK], [Diem_PB], [Diem_HD], [TongDiem]) VALUES (2021, 1, N'KTPM', N'SV05', N'DT03', NULL, NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[LichBaoVe] ([Nam], [Dot_BV], [MaNganh], [MaSV], [MaDT], [Diem_UV], [Diem_TK], [Diem_PB], [Diem_HD], [TongDiem]) VALUES (2021, 2, N'HTTT', N'SV06', N'DT02', NULL, NULL, NULL, NULL, NULL)
GO
INSERT [dbo].[LichBaoVe] ([Nam], [Dot_BV], [MaNganh], [MaSV], [MaDT], [Diem_UV], [Diem_TK], [Diem_PB], [Diem_HD], [TongDiem]) VALUES (2021, 2, N'HTTT', N'SV07', N'DT02', NULL, NULL, NULL, NULL, NULL)
GO
